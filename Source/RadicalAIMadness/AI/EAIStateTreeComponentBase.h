...
#include "EAIStateTreeComponentBase.generated.h"
...
class RADICALAIMADNESS_API UEAIStateTreeComponentBase : public UBrainComponent, public IGameplayTaskOwnerInterface
{
	GENERATED_BODY()
public:
	UEAIStateTreeComponentBase(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	const FStateTreeReference& GetStateTreeReference() const { return StateTreeRef; }
